...
(function($) {
        ...
        var process = (function(that) {
                return function() {
                    return (function() {
                        ...
                        if ( $.isFunction(this.onreadystatechange || this.onload) ) {
                            if( mockHandler.isTimeout) {
                                this.status = -1;
                            }
                            (this.onreadystatechange || this.onload)( mockHandler.isTimeout ? 'timeout' : undefined );
        ...
        if ( mockHandler.proxy ) {
            ...
            _ajax({
                ...
                complete: function(xhr) {
                    ...
                    that.responseTimer = setTimeout(process, mockHandler.responseTime || 0);

                    if (mockHandler.mockProgress) {
                        progress();
                    }
                }
            });
    ...
    function handleAjax( url, origSettings ) {
        ...
        for(var k = 0; k < mockHandlers.length; k++) {
            ...
            mockHandler.progress = requestSettings.progress;
